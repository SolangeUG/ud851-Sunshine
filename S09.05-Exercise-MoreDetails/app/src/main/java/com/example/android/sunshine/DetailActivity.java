...
public class DetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        highTempTextview = (TextView) findViewById(R.id.tv_display_high_temperature);
        lowTempTextView = (TextView) findViewById(R.id.tv_display_low_temperature);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, data.getInt(INDEX_WEATHER_CONDITION_ID));
        ...
        String humidity = getString(R.string.format_humidity, data.getFloat(INDEX_WEATHER_HUMIDITY));
        ...
        String pressure = getString(R.string.format_pressure, data.getFloat(INDEX_WEATHER_PRESSURE));
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        // let's not do anything in it yet!
    }
}